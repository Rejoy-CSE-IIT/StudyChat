...
public class c_userlist_selector_recycler_view_activity extends AppCompatActivity
{
    //Static Files
            ...
            public void onClick(View view, int position)
            {
                ...
                switch(dataE.getOptionName())
                {
                    ...
                    case "Chat App":
                        ...
                        if(c_userlist_selector_recycler_view_activity.TESTING_MODE)
                            Toast.makeText(c_userlist_selector_recycler_view_activity.this, "ChatApp"+dataE.getOptionName(), Toast.LENGTH_LONG).show();
                        ...
                        intent = new Intent(c_userlist_selector_recycler_view_activity.this, ChatMain_activity.class);
                    ...
                    case "Analytics":
                        ...
                        if(c_userlist_selector_recycler_view_activity.TESTING_MODE)
                            Toast.makeText(c_userlist_selector_recycler_view_activity.this, "Analytics"+dataE.getOptionName(), Toast.LENGTH_LONG).show();


                        intent = new Intent(c_userlist_selector_recycler_view_activity.this, a_analytics.class);
                        startActivity(intent);
...
*/
        ...
        adapter = new a_userlist_recycler_view_adapter_class(data,getApplicationContext());
